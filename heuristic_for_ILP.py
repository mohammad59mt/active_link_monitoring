...
def heuristic_for_ILP(topo, length_of_probes_array, ratio_of_numberOfProbes_to_numberOfLinks, max_number_probes, display_outputs=False):
    ...
    return nodeBasedPath_arrayOfList
...
nodeBasedPath_arrayOfList = heuristic_for_ILP(topo=topo, length_of_probes_array=length_of_probes_array,
                                               ratio_of_numberOfProbes_to_numberOfLinks=ratio_of_numberOfProbes_to_numberOfLinks, max_number_probes=max_number_probes,
